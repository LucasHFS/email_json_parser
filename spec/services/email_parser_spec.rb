  ...
  describe '.extract_json' do
    ...
    context 'when fetching email content from a URL fails' do
      it 'raises an appropriate error' do
        ...
        end.to raise_error('Error fetching email from URL: 404 Not Found')
      end
    end
    ...
    context 'when fetching email content from a file fails' do
      it 'raises an appropriate error' do
        ...
        end.to raise_error("Error reading email file: No such file or directory @ rb_sysopen - #{invalid_file_path}")
      end
    end
  end
end
